...
const RAS_OffScreen::AttachmentList& RAS_ICanvas::GetAttachments() const
{
	return m_attachments;
}

void RAS_ICanvas::SetAttachments(const RAS_OffScreen::AttachmentList& attachments)
{
...
{
	// TODO move construction when resizing only.
