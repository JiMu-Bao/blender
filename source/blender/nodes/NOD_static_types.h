...
DefNode( ShaderNode,     SH_NODE_OUTPUT_ATTACHEMENT, def_sh_output_attachement, "OUTPUT_ATTACHEMENT", OutputAttachement, "OutputAttachement",            ""              )
...
DefNode( ShaderNode,     SH_NODE_PARALLAX,        def_parallax,           "PARALLAX",       Parallax,         "Parallax",          ""              )
...
DefNode( ShaderNode,     SH_NODE_OBJECT,          0,                      "OBJECT",         ObjectData,       "Object Data",       ""              )
DefNode( ShaderNode,     SH_NODE_TIME,            0,                      "TIME",           Time,             "Time",              ""              )
